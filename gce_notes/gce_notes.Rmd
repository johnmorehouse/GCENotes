...
```{R, conf-bucket, out.width = "100%",out.height = "150%", echo = F}
knitr::include_graphics("figures/test-bucket.png")
```
...
```{R, conf-folder, out.width = "100%",out.height = "150%", echo = F}
knitr::include_graphics("figures/test-folder.png")
```
...
```{R, conf-data, out.width = "100%",out.height = "150%", echo = F}
knitr::include_graphics("figures/test-data.png")
```
